...
| [OpenCode](https://opencode.ai/) | Jun 2026 | Open source AI coding agent . Supports 75+ LLM providers, LSP integration, MCP tools, multi-session agents. Free tier: 200 req/5hr (Big Pickle + free models). Go subscription: $5→$10/mo unlocks DeepSeek V4 Pro/Flash, Qwen3.7 Max, GLM-5.2, MiMo-V2.5, Kimi K2.7 Code, MiniMax M3, etc. Desktop beta available. MIT, 178k stars|
